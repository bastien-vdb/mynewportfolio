...
function Experience() {
  return (
    <div className="experience">
      <Head>
        <title>Bastien Deboisrolin experience</title>
        <meta property="og:title" content="Bastien Deboisrolin experience" />
        <meta property="og:description" content="Bastien VDB Portfolio experience" />
